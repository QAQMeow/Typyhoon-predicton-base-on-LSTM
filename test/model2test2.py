...
model9.compile(loss='mse', optimizer =tf.keras.optimizers.Adam(learning_rate=0.0005, beta_1=0.9, beta_2=0.999))

history = model9.fit(train_X,train_Y,epochs=150,
...
modelname = 'model2-2 4steps'
PrintLossFig(history,modelname+' Training and validation loss')

#pre = model9.predict(test_X)

pre = forecast2(test_X,test_Y,model9,4)
